...
def extract_landmark_lang(nlp_pipeline, input_file, output_file):
...
if __name__ == '__main__':
    splits = ['train', 'val_seen', 'val_unseen', 'train_prevalent_generated']
    input_files = [split + '.jsonl' for split in splits]
    output_files = [split + '_landmark.jsonl' for split in splits]
    output_files_vis = [split + '_landmark_vis_score.jsonl' for split in splits]

    # nlp_pipeline = stanza.Pipeline('en', processors='tokenize,pos,lemma')

    # for input_file, output_file in zip(input_files, output_files):
    #     extract_landmark_lang(nlp_pipeline, input_file, output_file)
